...
const Sidebar = (props) => {
    return (
      <aside className="w-64" aria-label="Sidebar">
        <div className="overflow-y-auto w-64 h-screen fixed py-10 px-3 bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Admin Portal</span>
              </a>
            </li>
            <li>
            <Toggle />
          ...
          >
            ...
            <p className="mb-3 text-sm text-blue-900 dark:text-blue-400">
              Preview the new ZuriDao dashboard navigation! You can turn the new
